...
public:
    enum V { value = (sizeof( Head ) > tail_value) ? sizeof( Head ) : nanostl::size_t( tail_value ) } ;
...
struct helper
{
    ...
    static type_index_t move_construct( type_index_t const from_index, void * from_value, void * to_value )
    {
        switch ( from_index )
        {
        case 0: new( to_value ) T0( nanostl::move( *as<T0>( from_value ) ) ); break;
        case 1: new( to_value ) T1( nanostl::move( *as<T1>( from_value ) ) ); break;
        case 2: new( to_value ) T2( nanostl::move( *as<T2>( from_value ) ) ); break;
        case 3: new( to_value ) T3( nanostl::move( *as<T3>( from_value ) ) ); break;
        case 4: new( to_value ) T4( nanostl::move( *as<T4>( from_value ) ) ); break;
        case 5: new( to_value ) T5( nanostl::move( *as<T5>( from_value ) ) ); break;
        case 6: new( to_value ) T6( nanostl::move( *as<T6>( from_value ) ) ); break;
        case 7: new( to_value ) T7( nanostl::move( *as<T7>( from_value ) ) ); break;
        case 8: new( to_value ) T8( nanostl::move( *as<T8>( from_value ) ) ); break;
        case 9: new( to_value ) T9( nanostl::move( *as<T9>( from_value ) ) ); break;
        case 10: new( to_value ) T10( nanostl::move( *as<T10>( from_value ) ) ); break;
        case 11: new( to_value ) T11( nanostl::move( *as<T11>( from_value ) ) ); break;
        case 12: new( to_value ) T12( nanostl::move( *as<T12>( from_value ) ) ); break;
    ...
    static type_index_t move_assign( type_index_t const from_index, void * from_value, void * to_value )
    {
        switch ( from_index )
        {
        case 0: *as<T0>( to_value ) = nanostl::move( *as<T0>( from_value ) ); break;
        case 1: *as<T1>( to_value ) = nanostl::move( *as<T1>( from_value ) ); break;
        case 2: *as<T2>( to_value ) = nanostl::move( *as<T2>( from_value ) ); break;
        case 3: *as<T3>( to_value ) = nanostl::move( *as<T3>( from_value ) ); break;
        case 4: *as<T4>( to_value ) = nanostl::move( *as<T4>( from_value ) ); break;
        case 5: *as<T5>( to_value ) = nanostl::move( *as<T5>( from_value ) ); break;
        case 6: *as<T6>( to_value ) = nanostl::move( *as<T6>( from_value ) ); break;
        case 7: *as<T7>( to_value ) = nanostl::move( *as<T7>( from_value ) ); break;
        case 8: *as<T8>( to_value ) = nanostl::move( *as<T8>( from_value ) ); break;
        case 9: *as<T9>( to_value ) = nanostl::move( *as<T9>( from_value ) ); break;
        case 10: *as<T10>( to_value ) = nanostl::move( *as<T10>( from_value ) ); break;
        case 11: *as<T11>( to_value ) = nanostl::move( *as<T11>( from_value ) ); break;
        case 12: *as<T12>( to_value ) = nanostl::move( *as<T12>( from_value ) ); break;
...
template< nanostl::size_t K, class T0, class T1, class T2, class T3, class T4, class T5, class T6, class T7, class T8, class T9, class T10, class T11, class T12, class T13, class T14, class T15 >
...
#if variant_CPP11_OR_GREATER
variant_constexpr nanostl::size_t variant_npos = static_cast<nanostl::size_t>( -1 );
#else
...
public:
    ...
    variant( variant && other ) noexcept(
        nanostl::is_nothrow_move_constructible<T0>::value &&
        nanostl::is_nothrow_move_constructible<T1>::value &&
        nanostl::is_nothrow_move_constructible<T2>::value &&
        nanostl::is_nothrow_move_constructible<T3>::value &&
        nanostl::is_nothrow_move_constructible<T4>::value &&
        nanostl::is_nothrow_move_constructible<T5>::value &&
        nanostl::is_nothrow_move_constructible<T6>::value &&
        nanostl::is_nothrow_move_constructible<T7>::value &&
        nanostl::is_nothrow_move_constructible<T8>::value &&
        nanostl::is_nothrow_move_constructible<T9>::value &&
        nanostl::is_nothrow_move_constructible<T10>::value &&
        nanostl::is_nothrow_move_constructible<T11>::value &&
        nanostl::is_nothrow_move_constructible<T12>::value &&
        nanostl::is_nothrow_move_constructible<T13>::value &&
        nanostl::is_nothrow_move_constructible<T14>::value &&
        nanostl::is_nothrow_move_constructible<T15>::value)
        : type_index( other.type_index )
    {
    ...
    explicit variant( nonstd_lite_in_place_type_t(T), Args&&... args)
    {
        ...
        type_index = helper_type::template construct_t<T>( ptr(), nanostl::forward<Args>(args)... );
    }

    template< class T, class U, class... Args
        variant_REQUIRES_T( nanostl::is_constructible< T, nanostl::initializer_list<U>&, Args...>::value )
    >
    explicit variant( nonstd_lite_in_place_type_t(T), nanostl::initializer_list<U> il, Args&&... args )
    {
        type_index = variant_npos_internal();
        type_index = helper_type::template construct_t<T>( ptr(), il, nanostl::forward<Args>(args)... );
    }
    ...
    {
        type_index = variant_npos_internal();
        type_index = helper_type::template construct_i<K>( ptr(), il, nanostl::forward<Args>(args)... );
    }
    ...
    variant & operator=( variant && other ) noexcept(
        nanostl::is_nothrow_move_assignable<T0>::value &&
        nanostl::is_nothrow_move_assignable<T1>::value &&
        nanostl::is_nothrow_move_assignable<T2>::value &&
        nanostl::is_nothrow_move_assignable<T3>::value &&
        nanostl::is_nothrow_move_assignable<T4>::value &&
        nanostl::is_nothrow_move_assignable<T5>::value &&
        nanostl::is_nothrow_move_assignable<T6>::value &&
        nanostl::is_nothrow_move_assignable<T7>::value &&
        nanostl::is_nothrow_move_assignable<T8>::value &&
        nanostl::is_nothrow_move_assignable<T9>::value &&
        nanostl::is_nothrow_move_assignable<T10>::value &&
        nanostl::is_nothrow_move_assignable<T11>::value &&
        nanostl::is_nothrow_move_assignable<T12>::value &&
        nanostl::is_nothrow_move_assignable<T13>::value &&
        nanostl::is_nothrow_move_assignable<T14>::value &&
        nanostl::is_nothrow_move_assignable<T15>::value)
        {
    ...
    {
        return variant_npos_internal() == type_index ? variant_npos : static_cast<nanostl::size_t>( type_index );
    }
    ...
    {
        return this->template emplace< type_at_t<K> >( il, nanostl::forward<Args>(args)... );
    }
...
#if variant_CPP11_OR_GREATER
        noexcept(
            nanostl::is_nothrow_move_constructible<T0>::value && std17::is_nothrow_swappable<T0>::value &&
            nanostl::is_nothrow_move_constructible<T1>::value && std17::is_nothrow_swappable<T1>::value &&
            nanostl::is_nothrow_move_constructible<T2>::value && std17::is_nothrow_swappable<T2>::value &&
            nanostl::is_nothrow_move_constructible<T3>::value && std17::is_nothrow_swappable<T3>::value &&
            nanostl::is_nothrow_move_constructible<T4>::value && std17::is_nothrow_swappable<T4>::value &&
            nanostl::is_nothrow_move_constructible<T5>::value && std17::is_nothrow_swappable<T5>::value &&
            nanostl::is_nothrow_move_constructible<T6>::value && std17::is_nothrow_swappable<T6>::value &&
            nanostl::is_nothrow_move_constructible<T7>::value && std17::is_nothrow_swappable<T7>::value &&
            nanostl::is_nothrow_move_constructible<T8>::value && std17::is_nothrow_swappable<T8>::value &&
            nanostl::is_nothrow_move_constructible<T9>::value && std17::is_nothrow_swappable<T9>::value &&
            nanostl::is_nothrow_move_constructible<T10>::value && std17::is_nothrow_swappable<T10>::value &&
            nanostl::is_nothrow_move_constructible<T11>::value && std17::is_nothrow_swappable<T11>::value &&
...
private:
    ...
    using aligned_storage_t = typename nanostl::aligned_storage< data_size, data_align >::type;
...
#if variant_CPP11_OR_GREATER
    variant_REQUIRES_T(
        nanostl::is_move_constructible<T0>::value && std17::is_swappable<T0>::value &&
        nanostl::is_move_constructible<T1>::value && std17::is_swappable<T1>::value &&
        nanostl::is_move_constructible<T2>::value && std17::is_swappable<T2>::value &&
        nanostl::is_move_constructible<T3>::value && std17::is_swappable<T3>::value &&
        nanostl::is_move_constructible<T4>::value && std17::is_swappable<T4>::value &&
        nanostl::is_move_constructible<T5>::value && std17::is_swappable<T5>::value &&
        nanostl::is_move_constructible<T6>::value && std17::is_swappable<T6>::value &&
        nanostl::is_move_constructible<T7>::value && std17::is_swappable<T7>::value &&
        nanostl::is_move_constructible<T8>::value && std17::is_swappable<T8>::value &&
        nanostl::is_move_constructible<T9>::value && std17::is_swappable<T9>::value &&
        nanostl::is_move_constructible<T10>::value && std17::is_swappable<T10>::value &&
        nanostl::is_move_constructible<T11>::value && std17::is_swappable<T11>::value &&
...
#if variant_CPP11_OR_GREATER
        typedef typename variant_alternative<Idx, typename nanostl::decay<V1>::type>::type value_type;
#else
